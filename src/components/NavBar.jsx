...
  if (isMobile) {
    return (
      <div className="fixed bottom-4 left-1/2 transform -translate-x-1/2 z-[999] px-2 w-[calc(100%-1rem)] max-w-lg pointer-events-none">
        <div className="flex items-center justify-center bg-white/10 backdrop-blur-xl border border-gray-200/20
                        rounded-2xl px-2 py-2 shadow-xl gap-1 pointer-events-auto overflow-x-auto no-scrollbar">
